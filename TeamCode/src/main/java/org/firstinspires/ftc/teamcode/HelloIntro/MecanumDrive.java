...
public class MecanumDrive {
    ...
    public void driveWithError(double xError, double yError, double yawError){
        drive(
                Range.clip(xError * SPEED_GAIN, -MAX_AUTO_SPEED, MAX_AUTO_SPEED),
                Range.clip(yError * TURN_GAIN, -MAX_AUTO_TURN, MAX_AUTO_TURN),
                Range.clip(yawError * STRAFE_GAIN, -MAX_AUTO_STRAFE, MAX_AUTO_STRAFE)
        );
    }
}
