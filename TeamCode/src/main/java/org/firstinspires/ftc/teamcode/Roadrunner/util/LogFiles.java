...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = OppyMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = OppyMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = OppyMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = OppyMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = OppyMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = OppyMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = OppyMecanumDrive.LATERAL_MULTIPLIER;
